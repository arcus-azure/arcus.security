...
namespace Arcus.Security.Core.Providers
{
    ...
    public class MutatedSecretNameCachedSecretProvider : MutatedSecretNameSecretProvider, ICachedSecretProvider
    {
        ...
        public async Task<string> GetRawSecretAsync(string secretName, bool ignoreCache)
        {
            ...
            string secretValue = await SafeguardMutateSecretNameAsync(secretName, mutated => _implementation.GetRawSecretAsync(mutated, ignoreCache));
            return secretValue;
        }
        ...
        public async Task<Secret> GetSecretAsync(string secretName, bool ignoreCache)
        {
            ...
            Secret secret = await SafeguardMutateSecretNameAsync(secretName, mutated => _implementation.GetSecretAsync(mutated, ignoreCache));
            return secret;
        }
        ...
        public async Task InvalidateSecretAsync(string secretName)
        {
            ...
            await SafeguardMutateSecretNameAsync(secretName, mutated => _implementation.InvalidateSecretAsync(secretName));
        }
    }
}