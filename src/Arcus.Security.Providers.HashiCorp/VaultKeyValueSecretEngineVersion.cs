namespace Arcus.Security.Providers.HashiCorp
{
    ...
    /// <para>See the official HashiCorp Vault docs: <a href="https://www.vaultproject.io/docs/secrets/kv" /> for more information on this subject.</para>
    /// </summary>
    public enum VaultKeyValueSecretEngineVersion
    {
        ...
        /// <para>See the HashiCorp Vault docs: <a href="https://www.vaultproject.io/docs/secrets/kv/kv-v1" /> for more information on this version of the secret engine.</para>
        /// </summary>
        V1 = 1,
