...
namespace Arcus.Security.Tests.Integration.KeyVault
{
    ...
    public partial class DeprecatedKeyVaultSecretProviderTests : IntegrationTest
    {
        public DeprecatedKeyVaultSecretProviderTests(ITestOutputHelper testOutput) : base(testOutput)
        {
        }
