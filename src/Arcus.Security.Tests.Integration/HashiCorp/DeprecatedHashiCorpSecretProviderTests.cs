...
namespace Arcus.Security.Tests.Integration.HashiCorp
{
    ...
    public partial class DeprecatedHashiCorpSecretProviderTests : IntegrationTest
    {
        private const string DefaultDevMountPoint = "secret";

        /// <summary>
        /// Initializes a new instance of the <see cref="DeprecatedHashiCorpSecretProviderTests"/> class.
        /// </summary>
        public DeprecatedHashiCorpSecretProviderTests(ITestOutputHelper outputWriter) : base(outputWriter)
        {
        }
